...
export function BirthdayRouletteLauncher({ pendingKitId }: { pendingKitId: string | null }) {
  const [open, setOpen] = useState(true);
  if (!open) return null;
  return <BirthdayRouletteModal mode="real" pendingKitId={pendingKitId} onClose={() => setOpen(false)} />;
}
