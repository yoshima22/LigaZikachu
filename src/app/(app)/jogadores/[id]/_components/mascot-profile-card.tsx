      ...
      <div className="p-4 space-y-4">
        ...
        <div className="space-y-1">
          {[
            ...
            { label: "Agilidade",  emoji: "⚡", value: mascot.statAgility,  tip: "Pode acelerar em até 13% a segunda metade da expedição (até 6,5% do tempo total); também influencia iniciativa em batalhas" },
