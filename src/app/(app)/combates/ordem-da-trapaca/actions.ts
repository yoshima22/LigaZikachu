  ...
  const presets = [
    {
      ...
      description: "A Ordem lacrou a ZikaLoot e segurou as recompensas at? que a pista certa seja descoberta.",
    ...
    },
    {
      ...
      description: "A Ordem plantou uma oferta corrompida no meio do Bazar. Enquanto a travessura estiver ativa, esse espa?o n?o pode ser comprado.",
    ...
    },
    {
      ...
      title: "M?quina de an?lise engasgada",
      description: "A fuma?a roxa da Ordem travou a an?lise de mascotes no Laborat?rio at? que a origem da sabotagem seja descoberta.",
    ...
    },
    {
      ...
      title: "Pre?os adulterados",
      description: "Etiquetas falsas da Ordem tentam confundir a loja com valores suspeitos durante a investiga??o.",
    ...
    },
    {
      ...
      description: "A Ordem deixou marcas nos perfis dos jogadores. Algumas delas escondem parte do caminho at? o esconderijo.",
    ...
    },
    {
      ...
      description: "A Ordem mexeu nos tr?s primeiros slots das equipes da Liga Semanal e reduziu seus atributos pela metade.",
      effectJson: {
    ...
    },
    {
      ...
      description: "A Ordem espalhou armadilhas e rumores que deixam companheiros em destaque mais expostos a ataques surpresa durante a investiga??o.",
      effectJson: {
