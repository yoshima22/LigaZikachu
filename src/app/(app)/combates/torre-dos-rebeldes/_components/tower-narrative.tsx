...
export function TowerNarrativeArchive({groups}:{groups:Array<{id:string;title:string;scenes:Array<TowerNarrativeScene & {unlocked:boolean}>}>}) {
 ...
 return <section className="rounded-2xl border border-purple-400/25 bg-slate-950/80 p-4">
  <p className="text-[10px] font-black uppercase tracking-[.22em] text-purple-300">Seu arquivo narrativo com Xandinho</p>
  <h2 className="mt-1 text-xl font-black text-white">Diálogos encontrados por você</h2>
  <p className="mt-2 text-xs leading-5 text-slate-400">Cada jogador constrói a própria sequência narrativa conforme explora a Torre. Somente as cenas encontradas por você podem ser reassistidas aqui.</p>
