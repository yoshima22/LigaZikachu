...
export function MascotCard({ mascot, isAdmin = false, compactView = false, onRefresh, spritePreferences = null, eventExpBonusPct }: Props) {
  ...
  return (
    ...
    <div className={`h-fit min-w-0 max-w-full self-start rounded-2xl border bg-slate-950/60 transition-all ${mascot.isEquipped ? "border-[#FFCB05]/50 ring-1 ring-[#FFCB05]/20" : "border-border"}`}>
      {mascot.isEquipped && (
