          ...
          <div className="mx-3 mt-3 rounded-xl border border-border bg-slate-900/60 px-3 py-2 text-center sm:mx-5">
            {turn ? (
              <p className="text-[11px] text-slate-300">
                <span className={turn.isPlayerAttacker ? "text-blue-300 font-semibold" : "text-red-300 font-semibold"}>{turn.attackerName}{attackerLevel ? ` - Nv.${attackerLevel}` : ""}</span>
                ...
                {(turn.action ?? "ATTACK") === "DEFEND" ? (
                  ...
                  <>
                    {" "}atacou <span className={turn.isPlayerAttacker ? "text-red-300 font-semibold" : "text-blue-300 font-semibold"}>{turn.defenderName}{defenderLevel ? ` - Nv.${defenderLevel}` : ""}</span>
