...
export const SUGGESTED_PRICES: Record<string, Record<string, number>> = {
  ...
  ANTIDOTE:          { COMMON: 300, UNCOMMON: 300, RARE: 300, EPIC: 300, LEGENDARY: 300 },
  FIRST_AID_KIT:     { COMMON: 3000, UNCOMMON: 3000, RARE: 3000, EPIC: 3000, LEGENDARY: 3000 },
  ...
  PICNIC_BASKET:   { COMMON: 2500, UNCOMMON: 2500, RARE: 2500, EPIC: 2500, LEGENDARY: 2500 },
  VACATION_TICKET: { COMMON: 1600, UNCOMMON: 1600, RARE: 1600, EPIC: 1600, LEGENDARY: 1600 },
  XP_SHARE:        { COMMON: 8000, UNCOMMON: 8000, RARE: 8000, EPIC: 8000, LEGENDARY: 8000 },
  XP_SHARE_TEAM:   { COMMON: 8000, UNCOMMON: 8000, RARE: 8000, EPIC: 8000, LEGENDARY: 8000 },
  RAINBOW_FEATHER: { COMMON: 900, UNCOMMON: 900, RARE: 2000, EPIC: 3100, LEGENDARY: 4200 },
...
// Fonte única: novas Megas entram automaticamente em inventário, bazar e
...
export const UNIQUE_ITEM_TYPES: ReadonlySet<string> = new Set(["XP_SHARE", "XP_SHARE_TEAM"]);
