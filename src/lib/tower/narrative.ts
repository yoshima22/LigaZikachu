...
export const DEFAULT_TOWER_SCENES: TowerNarrativeScene[] = [
  {
    ...
    text: "Bem-vindos ao arquivo de expedições. Escolham a classe, preparem dois mascotes e confirmem o grupo; eu registrarei cada descoberta da Torre.",
    backgroundUrl: "/events/torre-dos-rebeldes/background.png",
    characterUrl: "https://fwxqywivezsixamietps.supabase.co/storage/v1/object/public/assets/CustomPokemonSprites/TorreDosRebeldesChandelure.png",
    characterSide: "LEFT",
    enabled: true,
    order: 0,
  },
  {
    ...
    backgroundUrl: "/events/torre-dos-rebeldes/background.png",
    characterUrl: "https://fwxqywivezsixamietps.supabase.co/storage/v1/object/public/assets/CustomPokemonSprites/06_meowth_rebelde.png",
    characterSide: "RIGHT",
    enabled: true,
    order: 10,
  },
