...
type BulkInteractionType = Extract<InteractionType, "PLAY" | "PET" | "FEED_FOOD" | "FEED_SWEET" | "FEED_RARE_SWEET">;
...
function isBulkInteractionType(value: string): value is BulkInteractionType {
  return value === "PLAY" || value === "PET" || value === "FEED_FOOD" || value === "FEED_SWEET" || value === "FEED_RARE_SWEET";
}
